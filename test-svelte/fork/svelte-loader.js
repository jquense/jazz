...
const hotApi = require.resolve('svelte-loader/lib/hot-api.js');
    ...
    .then(
      (processed) => {
        if (processed.dependencies && this.addDependency) {
          for (const dependency of processed.dependencies) {
            this.addDependency(dependency);
          }
        }

        const { js, css, warnings } = normalize(
        ...
        if (options.emitCss && css.code) {
          ...
          js.code += `\nimport * as styles from '${posixify(cssFilepath)}';\n`;
